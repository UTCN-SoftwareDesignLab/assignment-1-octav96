...
public class Constants {
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{CREATE_USER, READ_USER, DELETE_USER, UPDATE_USER,
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(CREATE_ACCOUNT, UPDATE_ACCOUNT, DELETE_ACCOUNT, VIEW_ACCOUNT));
